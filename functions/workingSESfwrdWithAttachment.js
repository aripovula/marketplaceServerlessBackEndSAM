"use strict";
// no trigger defined in Lambda console
// IAM ROLE: LambdaLetMeSendMailRole
// consists of BasicLambda execution role + below one:
// {
//     "Version": "2012-10-17",
//     "Statement": [{
//             "Effect": "Allow",
...
//             ],
//             "Resource": [
//                 "arn:aws:s3:::emails-from-ses-4me*",
//                 "arn:aws:s3:::emails-for-lambda*"
//             ]
//         },
//         {
//             "Effect": "Allow",
...
//             "Resource": [
//                 "arn:aws:lambda:us-east-1:123456789012:function:S3LambdaEmailForwarder",
//                 "arn:aws:lambda:us-east-1:123456789012:function:emailForwardWithSESandS3",
//                 "arn:aws:ses:us-east-1:123456789012:identity/ula@aripov.info"
//             ]
//         },
//         {
//             "Effect": "Allow",
...
var defaultConfig = {
  fromEmail: "ula@aripov.info",
  subjectPrefix: "FWD: ARIPOV@INFO: ",
  emailBucket: "emails-from-ses-4me",
  emailKeyPrefix: "ula/",
  forwardMapping: {
    "ula@aripov.info": [
      "ula@gmail.com"
